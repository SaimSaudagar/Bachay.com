...
import 'food_widgets/food_card.dart';
        ...
        children: [
          ...
          Padding(
            ...
            child: TabBar(
              ...
              tabs: [
                _buildAppBarTab("All", isSelected: _appBarTabController!.index == 0),
                _buildAppBarTab("Whole Grain", isSelected: _appBarTabController!.index == 1),
                _buildAppBarTab("Vegetables & Fungus", isSelected: _appBarTabController!.index == 2),
                _buildAppBarTab("Nuts", isSelected: _appBarTabController!.index == 3),
                _buildAppBarTab("Dairy", isSelected: _appBarTabController!.index == 4),
                _buildAppBarTab("Processed", isSelected: _appBarTabController!.index == 5),
              ],
            ),
          ),
          ...
          const FoodCard(
            ...
            tags: {'Vegan': true, 'Gluten Free': false, 'Dairy Free': true, 'Low Calorie': true, 'Vitamin C': true},
          ),
        const FoodCard(
            imageUrl: 'https://via.placeholder.com/150', 
            foodName: 'Noodles', 
