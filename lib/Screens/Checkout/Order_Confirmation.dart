...
class OrderConfirmationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Order Confirmations', style: outfitBold.copyWith(fontSize: getBigFontSize(context))),
        actions: [
          IconButton(
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text('Total: Rs. 1,445', style: interBold.copyWith(fontSize: getBigFontSize(context), color: Colors.red)),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('Delivery Information', style: outfitBold.copyWith(fontSize: getFontSize(context))),
          SizedBox(height: getSpacing(context)),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('Shipping Method', style: outfitBold.copyWith(fontSize: getFontSize(context))),
          SizedBox(height: getSpacing(context)),
          Row(
            children: [
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('Select Payment Method', style: outfitBold.copyWith(fontSize: getFontSize(context))),
          SizedBox(height: getSpacing(context)),
          Row(
            children: [
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          SizedBox(width: getSpacing(context)),
          Text(text, style: interRegular.copyWith(fontSize: getFontSize(context))),
          Spacer(),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Text('Order Details', style: outfitBold.copyWith(fontSize: getFontSize(context))),
              Spacer(),
              Text('View All Items', style: TextStyle(color: Colors.blue, fontSize: getFontSize(context))),
            ],
          ),
          SizedBox(height: getSpacing(context)),
          Row(
            children: [
              OrderItem(imageUrl: 'https://www.shutterstock.com/image-photo/black-tshirt-clothes-on-isolated-600nw-599532212.jpg', price: 'Rs. 1,472'),
              SizedBox(width: getSpacing(context)),
              OrderItem(imageUrl: 'https://www.shutterstock.com/image-photo/black-tshirt-clothes-on-isolated-600nw-599532212.jpg', price: 'Rs. 500'),
            ],
          ),
        ],
      ),
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Text(price, style: interRegular.copyWith(fontSize: getFontSize(context))),
      ],
    );
  }
}
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ElevatedButton(
        ...
        child: Text('Place Order', style: buttonTextStyle(context).copyWith(fontSize: getBigFontSize(context))),
      ),
    );
  }
}
