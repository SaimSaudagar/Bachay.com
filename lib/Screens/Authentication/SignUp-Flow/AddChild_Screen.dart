              ...
              children: [
                Expanded(
                  child: ElevatedButton(
                    ...
                    child: Row(
                      ...
                      children: [
                        Image.asset(
                          'assets/images/boy-icon.png' ),
                        SizedBox(width: getSpacing(context) * 2),
                        Text(
                          "It's a Boy!",
                          style: outfitBold.copyWith(fontSize: getFontSize(context) * 1.5,color:Colors.black),
                        ),
                      ],
                    ),
                  ),
                ...
                Expanded(
                  child: ElevatedButton(
                    onPressed: () {},
                    style: ElevatedButton.styleFrom(
                      padding: EdgeInsets.symmetric(vertical: getSpacing(context) * 5), backgroundColor: buttonColorPink,
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(30),
                      ),
                    ),
