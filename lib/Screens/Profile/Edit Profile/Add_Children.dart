...
//   const AddChildBottomSheet({Key? key}) : super(key: key);
...
//           ),
//           SizedBox(height: getSpacing(context) * 2),
//           _buildTextField(context, 'Child\'s Name', 'Enter Child Name'),
//           SizedBox(height: getSpacing(context) * 2),
//           _buildDateField(context, 'Date of Birth', 'Enter Child\'s Date of Birth'),
//           SizedBox(height: getSpacing(context) * 2),
...
class ChildDetails {
  ...
  ChildDetails({required this.name, required this.dateOfBirth, required this.imagePath});
}
